...
/* Global buffers */
static uint64_t sme2_input_buffer[SME2_ARRAYSIZE];
static uint64_t sme2_output_buffer[SME2_ARRAYSIZE];
...
test_result_t test_sme2_support(void)
{
	...
	/*
	 * ZER0 (ZT0) : ZERO all bytes of the ZT0 register.
	 *
	 */
	asm volatile(".inst 0xc0480001" : : : ); 	/* ZERO { ZT0 } */
