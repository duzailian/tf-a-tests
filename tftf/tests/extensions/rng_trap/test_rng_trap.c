...
/*
 * This test ensures that a RNDR read access causes a trap to EL3 and generates
...
/*
 * This test ensures that a RNDRRS read access causes a trap to EL3 and generates
 * a random number each time.
 */
