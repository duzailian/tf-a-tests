...
{
	tftf_irq_enable(PMU_PPI, GIC_HIGHEST_NS_PRIORITY);
	return host_test_realm_pmuv3(cmd);
}
...
test_result_t host_realm_sea_empty(void)
{
	...
	host_shared_data_set_host_val(&realm, 1U, 4U, HOST_ARG3_INDEX, base + PAGE_SIZE);
	host_shared_data_set_host_val(&realm, 1U, 5U, HOST_ARG3_INDEX, base + PAGE_SIZE);
	host_shared_data_set_host_val(&realm, 1U, 6U, HOST_ARG3_INDEX, base + PAGE_SIZE);
	host_shared_data_set_host_val(&realm, 1U, 7U, HOST_ARG3_INDEX, base + PAGE_SIZE);
