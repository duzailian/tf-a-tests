...
test_result_t hypervisor_retrieve_request_multiple_receivers_test_helper(
	...
	enum ffa_instruction_access instruction_access)
{
	 ...
	 */
	ffa_memory_retrieve_request_init(mb.send, handle, SENDER, 0, 0, 0, 0, 0,
					 0, 0, 0);
	 ...
	 */
	rx_region = mb.recv;
	TRY(compare_ffa_memory_regions(rx_region, &tx_region));
