 ...
 * SPMC.
 */
static bool verify_retrieve_response(struct ffa_memory_region *region,
				    ffa_id_t sender,
...
static test_result_t hypervisor_retrieve_request_test_helper(uint32_t mem_func)
{
	...
	struct ffa_memory_access receiver = ffa_memory_access_init_permissions_from_mem_func(SP_ID(1), mem_func);
