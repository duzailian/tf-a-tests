...
static bool verify_retrieve_reponse(struct ffa_memory_region *region,
				    ffa_id_t sender,
...
static bool verify_constituent(
	struct ffa_memory_region_constituent *constituent, uint32_t page_count)
{
