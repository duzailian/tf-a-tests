...
test_result_t test_hypervisor_memory_retrieve(void) {
        ...
        /* 2. Send Hypervisor Retrieve request according to section 16.4.3 of FFA v1.1-REL0 specification */
        ...
        /* 2.5. Verify the recieved `FFA_MEM_RETRIEVE_RESP` aligns with transaction description sent above */
        region = mb.recv;
