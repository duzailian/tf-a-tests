 ...
 *    in a certain time.
 *
 * 3. Send a blocking request to Cactus to sleep for more time than the timer.
 *
 * 4. While servicing the timer sleep request, the non-secure timer should
 *    fire and interrupt Cactus.
 *
 * 5. Make sure that the response isn't ready yet.
 *
 * 6. In the TFTF, check that the interrupt has been handled.
 *
 * 7. Return to Cactus to finish the request.
 */
