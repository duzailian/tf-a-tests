...
{
	/*
	 * FFA_VERSION interface is used to check SPM that functionality is supported.
	 * The variable "should_skip_test" is used to avoid problems with tests builds
	 * that do not regard to SPM, whilst allowing for test related with FFA
	 * interfaces to execute when relevant.
	 */
