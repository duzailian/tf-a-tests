...
/**************************************************************************
 * The scenario changes the active PAS for a NS buffer into Realm PAS.
 * Then it queries a SP to initiate a secure DMA operation on this buffer
 * through the SMMU.
 * The operation is expected to fail as a secure DMA transaction to a Realm
 * region fails GPC on the SMMU path.
 **************************************************************************/
