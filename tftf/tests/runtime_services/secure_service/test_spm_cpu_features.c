...
test_result_t test_simd_vectors_preserved(void)
{
	...
	return fp_vector_compare(
		(uint8_t*)simd_vectors_send, (uint8_t*)simd_vectors_receive,
...
test_result_t test_sve_vectors_preserved(void)
{
	...
	return fp_vector_compare(
		(uint8_t*)sve_vectors_send, (uint8_t*)sve_vectors_receive,
