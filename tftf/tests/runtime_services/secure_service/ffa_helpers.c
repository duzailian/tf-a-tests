...
/**
 * Helper to call memory send function whose func id is passed as parameter.
 * Returns a valid handle in case of successful operation or return
...
/**
 * Helper that initializes and sends memory region. The memory region's
 * configuration is statically defined and is implementation specific. However,
 * doing it ion this file for simplicity and for testing purposes.
 */
