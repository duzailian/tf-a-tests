				       ...
				       enum ffa_instruction_access instruction_access)
{
	...
	access.receiver_permssions.flags = 0;
	access.receiver_permssions.receiver = receiver;
	access.receiver_permssions.permissions.data_access = data_access;
	access.receiver_permssions.permissions.instruction_access =
		instruction_access;
