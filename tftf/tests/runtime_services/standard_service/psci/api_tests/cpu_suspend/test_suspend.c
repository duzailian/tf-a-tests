...
test_result_t test_psci_suspend_invalid(void)
{
	...
	/*
	 * If PSCI power state format detected is an extended one,
	 * (CPU_SUSPEND_FEAT_PSTATE_FORMAT_EXTENDED) then suspend request
	 * should be denied, flag (should_deny) to be set.
	 */
