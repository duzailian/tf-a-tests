...
test_result_t test_em_cpu_features(void)
{
	...
	case 0xD04:
	{
		VERBOSE("midr val matches A35 -> %x\n", midr_val);
		cpu_ptr = &cortex_A35_errata_list;
		break;
	}
	case 0xD03:
	{
		VERBOSE("midr val matches A53 = %x\n", midr_val);
		cpu_ptr = &cortex_A53_errata_list;
		break;
	}
	case 0xD07:
	{
		VERBOSE("midr val matches A57 = %x\n", midr_val);
		cpu_ptr = &cortex_A57_errata_list;
		break;
	}
	case 0xD08:
	{
		VERBOSE("midr val matches A72 = %x\n", midr_val);
		cpu_ptr = &cortex_A72_errata_list;
		break;
	}
	case 0xD0D:
	{
		VERBOSE("midr val matches A77 = %x\n", midr_val);
		cpu_ptr = &cortex_A77_errata_list;
		break;
	}
	case 0xD41:
	{
		VERBOSE("midr val matches A78 = %x\n", midr_val);
		cpu_ptr = &cortex_A78_errata_list;
		break;
	}
	case 0xD0C:
	{
		VERBOSE("midr val matches neoverse N1 = %x\n", midr_val);
		cpu_ptr = &neoverse_N1_errata_list;
		break;
	}
	case 0xD4B:
	{
		VERBOSE("midr val matches A78C = %x\n", midr_val);
		cpu_ptr = &cortex_A78C_errata_list;
		break;
	}
	case 0xD4F:
	{
		VERBOSE("midr val matches Demeter -> %x\n", midr_val);
		cpu_ptr = &neoverse_V2_errata_list;
		break;
	}
	case 0xD47:
	{
		VERBOSE("midr val matches A710 -> %x\n", midr_val);
		cpu_ptr = &cortex_A710_errata_list;
		break;
	}
	case 0xD46:
	{
		VERBOSE("midr val matches A510 -> %x\n", midr_val);
		cpu_ptr = &cortex_A510_errata_list;
		break;
	}
	case 0xD48:
	{
		VERBOSE("midr val matches X2 -> %x\n", midr_val);
		cpu_ptr = &cortex_X2_errata_list;
		break;
	}
	case 0xD49:
	{
		VERBOSE("midr val matches N2 -> %x\n", midr_val);
		cpu_ptr = &neoverse_N2_errata_list;
		break;
	}
	case 0xD40:
	{
		VERBOSE("midr val matches V1 -> %x\n", midr_val);
		cpu_ptr = &neoverse_V1_errata_list;
		break;
	}
	case 0xD44:
	{
		VERBOSE("midr val matches X1 > %x\n", midr_val);
		cpu_ptr = &cortex_X1_errata_list;
		break;
	}
	case 0xD0A:
	{
		VERBOSE("midr val matches A75 > %x\n", midr_val);
		cpu_ptr = &cortex_A75_errata_list;
		break;
	}
	case 0xD05:
	{
		VERBOSE("midr val matches A55 > %x\n", midr_val);
		cpu_ptr = &cortex_A55_errata_list;
		break;
	}
	case 0xD42:
	{
		VERBOSE("midr val matches A78_AE > %x\n", midr_val);
		cpu_ptr = &cortex_A78_AE_errata_list;
		break;
	}
	default:
	{
		ERROR("midr value did not match\n");
		return TEST_RESULT_FAIL;
		break;
	}
	}
