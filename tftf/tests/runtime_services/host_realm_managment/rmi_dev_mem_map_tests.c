...
test_result_t host_realm_dev_mem_map_unmap(void)
{
	...
	struct dev_mem_info mem_info[NUM_INFO_TESTS] = {
		{PCIE_MEM_1_BASE, RTT_MAX_LEVEL, RTT_MAP_SIZE(RTT_MAX_LEVEL), NUM_L3_REGIONS},
		{PCIE_MEM_2_BASE, RTT_MAX_LEVEL, RTT_MAP_SIZE(RTT_MAX_LEVEL), NUM_L3_REGIONS},
		{PCIE_MEM_2_BASE, DEV_BLOCK_LEVEL, RTT_MAP_SIZE(DEV_BLOCK_LEVEL), NUM_L2_REGIONS}
	};
	unsigned int num[NUM_INFO_TESTS] = {0U, 0U, 0U};
