...
test_result_t host_pdev_test_valid_state_transition(void)
{
	...
	unsigned int i;
	u_register_t rmi_feat_reg0;
	unsigned char pdev_valid_state_transition[][PDEV_STATE_TRANSITION_MAX] = {
		{
			RMI_PDEV_STATE_NEW,
...
test_result_t host_pdev_invoke_ide_refresh_reset(void)
{
	...
	u_register_t rmi_feat_reg0;
	bool return_error = false;
	unsigned char pdev_ide_refresh_reset[] = {
	...
	/* TF-RMM main do not support IDE. Skip this testcase temporarily */
	return TEST_RESULT_SKIPPED;
