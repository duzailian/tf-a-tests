...
{
	s2tte |= INPLACE(S2TTE_PERM_PI_INDEX_BIT0, pi_index & 1) |
		INPLACE(S2TTE_PERM_PI_INDEX_BIT1, (pi_index >> 1) & 1) |
		INPLACE(S2TTE_PERM_PI_INDEX_BIT2, (pi_index >> 2) & 1) |
		INPLACE(S2TTE_PERM_PI_INDEX_BIT3, (pi_index >> 3) & 1);
	return s2tte;
}
