...
static host_shared_data_t *host_shared_data =
		((host_shared_data_t *)(PLATFORM_SHARED_REGION_BASE));
static host_shared_data_t *gest_shared_data;
/*
...
{
	return gest_shared_data->host_param_val[(index >= MAX_DATA_SIZE) ?
...
{
	(void)memset((char *)host_shared_data->realm_out_val,
		0,
...
{
	(void)memset((char *)host_shared_data->host_param_val,
		0,
...
{
	return gest_shared_data->realm_cmd;
}
