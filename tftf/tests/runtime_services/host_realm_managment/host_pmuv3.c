...
#define PMCCFILTR_EL0_MASK                                                     \
	(PMCCFILTR_EL0_P_BIT | PMCCFILTR_EL0_U_BIT | PMCCFILTR_EL0_NSK_BIT |   \
	 PMCCFILTR_EL0_NSH_BIT | PMCCFILTR_EL0_M_BIT | PMCCFILTR_EL0_RLK_BIT | \
	 PMCCFILTR_EL0_RLU_BIT | PMCCFILTR_EL0_RLH_BIT)

/* PMEVTYPER<n>_EL0 mask */
#define PMEVTYPER_EL0_MASK                                                     \
	(PMEVTYPER_EL0_P_BIT | PMEVTYPER_EL0_U_BIT | PMEVTYPER_EL0_NSK_BIT |   \
	 PMEVTYPER_EL0_NSU_BIT | PMEVTYPER_EL0_NSH_BIT | PMEVTYPER_EL0_M_BIT | \
	 PMEVTYPER_EL0_RLK_BIT | PMEVTYPER_EL0_RLU_BIT |                       \
	 PMEVTYPER_EL0_RLH_BIT | PMEVTYPER_EL0_EVTCOUNT_BITS)
