...
{
	/*
	 * Disabling the P and M bits tells the counter to increment at EL3.
...
static inline void configure_pmu_cycle_cntr()
{
...
test_result_t smc_psci_suspend_pc_write_retired(void)
{
	...
	SKIP_TEST_IF_DEBUG_VERSION_LESS_THAN(ID_AA64DFR0_V8_2_DEBUG_ARCH_SUPPORTED);
