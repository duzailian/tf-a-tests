...
static inline void configure_pmu_cntr0(const uint32_t event)
{
	 ...
	 * The counter therefore is told to count only at EL3 and secure EL1.
	 * This is to ensure maximum accuracy of the results, since we are only
	 * interested in the secure world leaking PMU counters.
	 */
