...
void tegra_set_rtc_as_wakeup_source(void)
{
	...
	aowake_write_32(WAKE_AOWAKE_TIER2_CTRL_0,
			WAKE_AOWAKE_TIER2_CTRL_0_INT_EN_TRUE);

	/* Configure the RTC wake up source as per the golden register value */
	aowake_write_32(WAKE_AOWAKE_CNTRL_73,
			WAKE_AOWAKE_CNTRL_73_COAL_EN_FIELD |
	...
	aowake_write_32(WAKE_AOWAKE_STATUS_W_73,
			WAKE_AOWAKE_STATUS_W_73_CLEAR_FALSE);
	aowake_write_32(WAKE_AOWAKE_MASK_W_73,
