...
/*
 * The Corstone1000 power domain tree descriptor. Corstone1000 implements a
 * system power domain at the level 2. The first entry in the power domain
 * descriptor specifies the number of power domains at the highest power level.
 * For Corstone1000 this is 1 i.e. the number of system power domain.
 */
