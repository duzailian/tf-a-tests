...
#define CLUSTER_DEF(cluster) CPU_DEF(cluster, 0)
#elif (FVP_MAX_CPUS_PER_CLUSTER == 2)
#define CLUSTER_DEF(cluster) CPU_DEF(cluster, 0), CPU_DEF(cluster, 1)
#elif (FVP_MAX_CPUS_PER_CLUSTER == 3)
#define CLUSTER_DEF(cluster) \
	CPU_DEF(cluster, 0), CPU_DEF(cluster, 1), CPU_DEF(cluster, 2)
...
#define CLUSTER_DEF(cluster)                                           \
	CPU_DEF(cluster, 0), CPU_DEF(cluster, 1), CPU_DEF(cluster, 2), \
		CPU_DEF(cluster, 3), CPU_DEF(cluster, 4)
#elif (FVP_MAX_CPUS_PER_CLUSTER == 6)
#define CLUSTER_DEF(cluster)                                           \
	CPU_DEF(cluster, 0), CPU_DEF(cluster, 1), CPU_DEF(cluster, 2), \
		CPU_DEF(cluster, 3), CPU_DEF(cluster, 4), CPU_DEF(cluster, 5)
...
#define CLUSTER_DEF(cluster)                                                   \
	CPU_DEF(cluster, 0), CPU_DEF(cluster, 1), CPU_DEF(cluster, 2),         \
		CPU_DEF(cluster, 3), CPU_DEF(cluster, 4), CPU_DEF(cluster, 5), \
		CPU_DEF(cluster, 6), CPU_DEF(cluster, 7)
...
uint64_t tftf_plat_get_mpidr(unsigned int core_pos)
{
	...
	mpid = make_mpid(fvp_base_aemv8a_aemv8a_cores[core_pos].cluster_id,
#if FVP_MAX_PE_PER_CPU > 1
