 ...
 */
#define get_sp_rx_start(sp_id) \
	(SP_RX_BASE + (((sp_id & 0x7FFFU) - 1U) * SP_RX_TX_SIZE))
#define get_sp_rx_end(sp_id) \
	(SP_RX_BASE + (((sp_id & 0x7FFFU) - 1U) * SP_RX_TX_SIZE) + PAGE_SIZE)
#define get_sp_tx_start(sp_id) \
	(SP_TX_BASE + (((sp_id & 0x7FFFU) - 1U) * SP_RX_TX_SIZE))
#define get_sp_tx_end(sp_id) \
	(SP_TX_BASE + (((sp_id & 0x7FFFU) - 1U) * SP_RX_TX_SIZE) + PAGE_SIZE)
