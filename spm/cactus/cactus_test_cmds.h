 ...
 * a deadlock. This aims at proving such scenario can not happen.
 ...
 *
 * The id is the hex representation of teh string 'dead'.
 */
#define CACTUS_DEADLOCK_CMD U(0x64656164aaa)
