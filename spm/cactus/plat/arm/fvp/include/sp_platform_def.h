...
#define PLAT_ARM_VIRTIO_BASE		ULL(0x1c130000)
#define PLAT_ARM_VIRTIO_SIZE		ULL(0x10000)

#define PLAT_ARM_SMMUV3_BASE		ULL(0x2BFE0000)
#define PLAT_ARM_SMMUV3_SIZE		ULL(0x20000)

#define PLAT_ARM_SP805_BASE		ULL(0x2A490000)
#define PLAT_ARM_SP805_SIZE		ULL(0x20000)
