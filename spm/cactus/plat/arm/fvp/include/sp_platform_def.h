...
#define PLAT_CACTUS_UART_BASE		PL011_UART2_BASE
#define PLAT_CACTUS_UART_SIZE		ULL(0x20000)

#define PLAT_CACTUS_ESPI_TEST_NODE_BASE	ULL(0x1c130000)
#define PLAT_CACTUS_ESPI_TEST_NODE_SIZE	ULL(0x10000)

#define PLAT_CACTUS_SMMUV3_BASE		ULL(0x2BFE0000)
#define PLAT_CACTUS_SMMUV3_SIZE		ULL(0x20000)

#define PLAT_CACTUS_SEC_WDOG_BASE	ULL(0x2A490000)
#define PLAT_CACTUS_SEC_WDOG_SIZE	ULL(0x20000)
