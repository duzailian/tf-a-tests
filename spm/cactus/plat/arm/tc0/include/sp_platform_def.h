...
#define SP_PL011_UART_BASE		PL011_UART1_BASE
#define SP_PL011_UART_CLK_IN_HZ		PL011_UART1_CLK_IN_HZ

#define PLAT_SP_RX_BASE			ULL(0xfe300000)
#define PLAT_SP_CORE_COUNT		(8)

/* Scratch memory used for SMMUv3 driver testing purposes in Cactus SP */
/* SMMUv3 tests are disabled for TC platform */
#define PLAT_SP_MEMCPY_BASE		ULL(0xfe400000)
