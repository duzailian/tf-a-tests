...
#define DEFINE_COMPILERRT_THUMB_FUNCTION(name)                 \
	...
	SYMBOL_IS_FUNC(SYMBOL_NAME(name))                      \
	SEPARATOR DECLARE_SYMBOL_VISIBILITY(name)              \
		SEPARATOR.thumb_func SEPARATOR                 \
		SYMBOL_NAME(name)                              \
	    :
...
#define DEFINE_COMPILERRT_PRIVATE_FUNCTION(name)                            \
	...
	SEPARATOR                                                           \
	SYMBOL_IS_FUNC(SYMBOL_NAME(name))                                   \
	SEPARATOR HIDDEN(SYMBOL_NAME(name)) SEPARATOR DECLARE_FUNC_ENCODING \
	SYMBOL_NAME(name)                                                   \
	    :
...
#define DEFINE_COMPILERRT_FUNCTION_ALIAS(name, target)                       \
	...
	SEPARATOR                                                            \
	SYMBOL_IS_FUNC(SYMBOL_NAME(name))                                    \
	SEPARATOR DECLARE_SYMBOL_VISIBILITY(SYMBOL_NAME(name)) SEPARATOR.set \
	SYMBOL_NAME(name),                                                   \
