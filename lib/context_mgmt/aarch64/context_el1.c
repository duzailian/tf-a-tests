...
#define EL1_CTX_MODIFY_MASK		ULL(0xffff0000)
...
{
#if CTX_INCLUDE_AARCH32_REGS
	el1_aarch32_regs_t *el1_aarch32 = get_el1_el1_aarch32_regs_ctx(el1_ctx);
...
/**
 * Public Function: modify_el1_sysregs.
 *
 * @brief: To modify the EL1 registers
 * @param: EL1 system register context struct(el1_ctx_regs_t)
 */
void modify_el1_context_sysregs(const el1_ctx_regs_t *el1_ctx)
{
	write_el1_ctx_common_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_aarch32_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_timer_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_mte2_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_ras_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_s1pie_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_s1poe_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_s2poe_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_tcr2_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_trf_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_csv2_2_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
	write_el1_ctx_gcs_regs(el1_ctx, EL1_CTX_MODIFY_MASK);
}

/**
 * Public Function: restore_el1_sysregs_context.
 *
 * @brief: To restore the EL1 registers to their original values
 * @param: EL1 system register context struct(el1_ctx_regs_t)
 */
void restore_el1_context_sysregs(const el1_ctx_regs_t *el1_ctx)
{
	write_el1_ctx_common_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_aarch32_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_timer_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_mte2_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_ras_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_s1pie_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_s1poe_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_s2poe_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_tcr2_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_trf_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_csv2_2_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
	write_el1_ctx_gcs_regs(el1_ctx, EL1_CTX_RESTORE_MASK);
}
