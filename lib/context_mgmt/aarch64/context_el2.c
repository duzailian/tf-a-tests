...
static void el2_write_common_registers_with_mask(el2_common_regs_t *ctx, uint64_t or_mask)
{
...
static void el2_write_mte2_registers_with_mask(el2_mte2_regs_t *ctx, uint64_t or_mask)
{
	if (get_armv8_5_mte_support() == 2)
		EL2_WRITE_MASK_CTX_REG(ctx, tfsr_el2, or_mask);
}

static void el2_write_fgt_registers_with_mask(el2_fgt_regs_t *ctx, uint64_t or_mask)
{
	if (is_armv8_6_fgt_present()) {
...
static void el2_write_fgt2_registers_with_mask(el2_fgt2_regs_t *ctx, uint64_t or_mask)
{
	if (is_armv8_9_fgt2_present()) {
...
static void el2_write_ecv_registers_with_mask(el2_ecv_regs_t *ctx, uint64_t or_mask)
{
	if (get_armv8_6_ecv_support() == ID_AA64MMFR0_EL1_ECV_SELF_SYNCH)
		EL2_WRITE_MASK_CTX_REG(ctx, cntpoff_el2, or_mask);
}

static void el2_write_vhe_registers_with_mask(el2_vhe_regs_t *ctx, uint64_t or_mask)
{
	if (is_armv8_1_vhe_present()) {
...
static void el2_write_ras_registers_with_mask(el2_ras_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_ras_present() || is_feat_rasv1p1_present()) {
...
static void el2_write_neve_registers_with_mask(el2_neve_regs_t *ctx, uint64_t or_mask)
{
	if (is_armv8_4_nv2_present())
		EL2_WRITE_MASK_CTX_REG(ctx, vncr_el2, or_mask);
}

static void el2_write_trf_registers_with_mask(el2_trf_regs_t *ctx, uint64_t or_mask)
{
	if (get_armv8_4_trf_support())
		EL2_WRITE_MASK_CTX_REG(ctx, trfcr_el2, or_mask);
}

static void el2_write_csv2_registers_with_mask(el2_csv2_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_csv2_2_present())
		EL2_WRITE_MASK_CTX_REG(ctx, scxtnum_el2, or_mask);
}

static void el2_write_hcx_registers_with_mask(el2_hcx_regs_t *ctx, uint64_t or_mask)
{
	if (get_feat_hcx_support())
		EL2_WRITE_MASK_CTX_REG(ctx, hcrx_el2, or_mask);
}

static void el2_write_tcr2_registers_with_mask(el2_tcr2_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_tcr2_present())
		EL2_WRITE_MASK_CTX_REG(ctx, tcr2_el2, (or_mask & ~TCR2_EL2_POE));
}

static void el2_write_sxpoe_registers_with_mask(el2_sxpoe_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_sxpoe_present())
		EL2_WRITE_MASK_CTX_REG(ctx, por_el2, or_mask);
}

static void el2_write_sxpie_registers_with_mask(el2_sxpie_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_sxpie_present()) {
...
static void el2_write_s2pie_registers_with_mask(el2_s2pie_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_s2pie_present())
		EL2_WRITE_MASK_CTX_REG(ctx, s2pir_el2, or_mask);
}

static void el2_write_gcs_registers_with_mask(el2_gcs_regs_t *ctx, uint64_t or_mask)
{
	if (is_feat_gcs_present()) {
...
static void el2_dump_common_register_context(el2_common_regs_t *ctx)
{
	...
	EL2_PRINT_CTX_FOOTER();
}

static void el2_dump_mte2_register_context(el2_mte2_regs_t *ctx)
{
...
static void el2_dump_fgt_register_context(el2_fgt_regs_t *ctx)
{
...
static void el2_dump_fgt2_register_context(el2_fgt2_regs_t *ctx)
{
...
static void el2_dump_ecv_register_context(el2_ecv_regs_t *ctx)
{
...
static void el2_dump_vhe_register_context(el2_vhe_regs_t *ctx)
{
...
static void el2_dump_ras_register_context(el2_ras_regs_t *ctx)
{
...
static void el2_dump_neve_register_context(el2_neve_regs_t *ctx)
{
...
static void el2_dump_trf_register_context(el2_trf_regs_t *ctx)
{
...
static void el2_dump_csv2_register_context(el2_csv2_regs_t *ctx)
{
...
static void el2_dump_hcx_register_context(el2_hcx_regs_t *ctx)
{
...
static void el2_dump_tcr2_register_context(el2_tcr2_regs_t *ctx)
{
...
static void el2_dump_sxpoe_register_context(el2_sxpoe_regs_t *ctx)
{
...
static void el2_dump_sxpie_register_context(el2_sxpie_regs_t *ctx)
{
...
static void el2_dump_s2pie_register_context(el2_s2pie_regs_t *ctx)
{
...
static void el2_dump_gcs_register_context(el2_gcs_regs_t *ctx)
{
...
static void el2_dump_mpam_register_context(el2_mpam_regs_t *ctx)
{
...
/**
 * Corrupt EL2 system registers from a given context pointer,
 * with an OR mask of value REG_CORRUPTION_MASK.
 */
void el2_corrupt_registers(el2_sysregs_t *ctx)
{
	el2_write_common_registers_with_mask(&ctx->common, REG_CORRUPTION_MASK);
	el2_write_mte2_registers_with_mask(&ctx->mte2, REG_CORRUPTION_MASK);
	el2_write_fgt_registers_with_mask(&ctx->fgt, REG_CORRUPTION_MASK);
	el2_write_fgt2_registers_with_mask(&ctx->fgt2, REG_CORRUPTION_MASK);
	el2_write_ecv_registers_with_mask(&ctx->ecv, REG_CORRUPTION_MASK);
	el2_write_vhe_registers_with_mask(&ctx->vhe, REG_CORRUPTION_MASK);
	el2_write_ras_registers_with_mask(&ctx->ras, REG_CORRUPTION_MASK);
	el2_write_neve_registers_with_mask(&ctx->neve, REG_CORRUPTION_MASK);
	el2_write_trf_registers_with_mask(&ctx->trf, REG_CORRUPTION_MASK);
	el2_write_csv2_registers_with_mask(&ctx->csv2, REG_CORRUPTION_MASK);
	el2_write_hcx_registers_with_mask(&ctx->hcx, REG_CORRUPTION_MASK);
	el2_write_tcr2_registers_with_mask(&ctx->tcr2, REG_CORRUPTION_MASK);
	el2_write_sxpoe_registers_with_mask(&ctx->sxpoe, REG_CORRUPTION_MASK);
	el2_write_sxpie_registers_with_mask(&ctx->sxpie, REG_CORRUPTION_MASK);
	el2_write_s2pie_registers_with_mask(&ctx->s2pie, REG_CORRUPTION_MASK);
	el2_write_gcs_registers_with_mask(&ctx->gcs, REG_CORRUPTION_MASK);
	/* There is nothing to do in regards to MPAM registers. */
}

/**
 * Restore EL2 system registers from a given context pointer,
 * with an OR mask of value 0.
 */
void el2_restore_registers(el2_sysregs_t *ctx)
{
	el2_write_common_registers_with_mask(&ctx->common, 0);
	el2_write_mte2_registers_with_mask(&ctx->mte2, 0);
	el2_write_fgt_registers_with_mask(&ctx->fgt, 0);
	el2_write_fgt2_registers_with_mask(&ctx->fgt2, 0);
	el2_write_ecv_registers_with_mask(&ctx->ecv, 0);
	el2_write_vhe_registers_with_mask(&ctx->vhe, 0);
	el2_write_ras_registers_with_mask(&ctx->ras, 0);
	el2_write_neve_registers_with_mask(&ctx->neve, 0);
	el2_write_trf_registers_with_mask(&ctx->trf, 0);
	el2_write_csv2_registers_with_mask(&ctx->csv2, 0);
	el2_write_hcx_registers_with_mask(&ctx->hcx, 0);
	el2_write_tcr2_registers_with_mask(&ctx->tcr2, 0);
	el2_write_sxpoe_registers_with_mask(&ctx->sxpoe, 0);
	el2_write_sxpie_registers_with_mask(&ctx->sxpie, 0);
	el2_write_s2pie_registers_with_mask(&ctx->s2pie, 0);
	el2_write_gcs_registers_with_mask(&ctx->gcs, 0);
	/* There is nothing to do in regards to MPAM registers. */
}
 ...
 */
void el2_dump_register_context(const char *ctx_name, el2_sysregs_t *ctx)
{
	EL2_PRINT_CTX_HEADING_INITIAL(ctx_name);
