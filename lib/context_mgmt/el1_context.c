 ...
 * --------------------------------------------------------------
 */
static void save_el1_ctx_common_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_aarch32_regs(el1_ctx_regs_t *ctx)
{
#if CTX_INCLUDE_AARCH32_REGS
	el1_aarch32_regs_t * el1_aarch32 = get_el1_el1_aarch32_regs_ctx(ctx);
...
static void save_el1_ctx_timer_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_mte2_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_ras_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_s1pie_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_s1poe_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_s2poe_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_tcr2_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_trf_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_csv2_2_regs(el1_ctx_regs_t *ctx)
{
...
static void save_el1_ctx_gcs_regs(el1_ctx_regs_t *ctx)
{
 ...
 */
void save_el1_sysregs_context(el1_ctx_regs_t *el1_ctx)
{
 ...
 * ------------------------------------------------------------------
 */
static void print_el1_context_common_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_common_regs_t *el1_common = get_el1_common_regs_ctx(el1_ctx);
...
static void print_el1_context_aarch32_sysregs(el1_ctx_regs_t *el1_ctx)
{
#if CTX_INCLUDE_AARCH32_REGS
	const el1_aarch32_regs_t * el1_aarch32 = get_el1_el1_aarch32_regs_ctx(el1_ctx);
...
static void print_el1_context_timer_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_arch_timer_regs_t * el1_arch_timer = get_el1_arch_timer_regs_ctx(el1_ctx);
...
static void print_el1_context_mte2_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_mte2_regs_t *el1_mte2 = get_el1_mte2_regs_ctx(el1_ctx);
...
static void print_el1_context_ras_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_ras_regs_t *el1_ras = get_el1_ras_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_ras, disr_el1);
}

static void print_el1_context_s1pie_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_s1pie_regs_t *el1_s1pie = get_el1_s1pie_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_s1pie, pire0_el1);
	PRINT_CTX_MEMBER(el1_s1pie, pir_el1);
}

static void print_el1_context_s1poe_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_s1poe_regs_t *el1_s1poe = get_el1_s1poe_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_s1poe, por_el1);
}

static void print_el1_context_s2poe_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_s2poe_regs_t *el1_s2poe = get_el1_s2poe_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_s2poe, s2por_el1);

}

static void print_el1_context_tcr2_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_tcr2_regs_t *el1_tcr2 = get_el1_tcr2_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_tcr2, tcr2_el1);

}

static void print_el1_context_trf_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_trf_regs_t *el1_trf = get_el1_trf_regs_ctx(el1_ctx);
	PRINT_CTX_MEMBER(el1_trf, trfcr_el1);
}

static void print_el1_context_csv2_2_sysregs(el1_ctx_regs_t *el1_ctx)
{
...
static void print_el1_context_gcs_sysregs(el1_ctx_regs_t *el1_ctx)
{
	const el1_gcs_regs_t *el1_gcs = get_el1_gcs_regs_ctx(el1_ctx);
 ...
 */
void print_el1_sysregs_context(el1_ctx_regs_t *el1_ctx)
{
	PRINT_CTX_MEM_SEPARATOR();
	printf("| EL1 Context Registers |        Value       |\n");
	PRINT_CTX_MEM_SEPARATOR();
	print_el1_context_common_sysregs(el1_ctx);
	print_el1_context_aarch32_sysregs(el1_ctx);
	print_el1_context_timer_sysregs(el1_ctx);
	print_el1_context_mte2_sysregs(el1_ctx);
	print_el1_context_ras_sysregs(el1_ctx);
	print_el1_context_s1pie_sysregs(el1_ctx);
	print_el1_context_s1poe_sysregs(el1_ctx);
	print_el1_context_s2poe_sysregs(el1_ctx);
	print_el1_context_tcr2_sysregs(el1_ctx);
	print_el1_context_trf_sysregs(el1_ctx);
	print_el1_context_csv2_2_sysregs(el1_ctx);
	print_el1_context_gcs_sysregs(el1_ctx);
	printf("\n");
}
 ...
 *
 * @brief: To compare two explicit EL1 context structure values and return the
 *         status as (TRUE) if equal or (FALSE) if not-equal.
 * @param: EL1 system register context struct pointers ( el1_ctx_regs_t *, el1_ctx_regs_t *)
 */
