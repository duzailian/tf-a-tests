...
{
	u_register_t tgran4 = get_id_aa64mmfr0_el0_tgran4();

	if (size == PAGE_SIZE_4KB) {
		return (tgran4 == ID_AA64MMFR0_EL1_TGRAN4_SUPPORTED) ||
		       (tgran4 == ID_AA64MMFR0_EL1_TGRAN4_52B_SUPPORTED);
	} else if (size == PAGE_SIZE_16KB) {
		return get_id_aa64mmfr0_el0_tgran16() == ID_AA64MMFR0_EL1_TGRAN16_SUPPORTED;
	} else if (size == PAGE_SIZE_64KB) {
		return get_id_aa64mmfr0_el0_tgran64() == ID_AA64MMFR0_EL1_TGRAN64_SUPPORTED;
	} else {
		return 0;
	}
}
