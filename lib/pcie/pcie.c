...
static uint64_t g_bar64_p_start  = PLATFORM_OVERRIDE_PCIE_BAR64_VALUE;
static uint64_t g_rp_bar64_value = PLATFORM_OVERRIDE_RP_BAR64_VALUE;
static uint64_t g_bar64_p_max;
static uint32_t g_64_bus, g_bar64_size;

/* 32-bit address initialisation */
static uint32_t g_bar32_np_start = PLATFORM_OVERRIDE_PCIE_BAR32NP_VALUE;
static uint32_t g_bar32_p_start  = PLATFORM_OVERRIDE_PCIE_BAR32P_VALUE;
static uint32_t g_rp_bar32_value = PLATOFRM_OVERRIDE_RP_BAR32_VALUE;
