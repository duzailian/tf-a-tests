...
.PHONY: help
help:
	@echo "usage: ${MAKE} PLAT=<${PLATFORMS}> <all|tftf|ns_bl1u|ns_bl2u|cactus|ivy|quark|el3_payload|distclean|clean|checkcodebase|checkpatch|help_tests>"
	@echo ""
	...
	@echo "  help_tests     List all possible set of tests"
	@echo ""
