...
.PHONY: realm_packaging
realm_packaging: realm tftf
...
<all|tftf|ns_bl1u|ns_bl2u|cactus|ivy|quark|realm|el3_payload|distclean|clean|checkcodebase|checkpatch|help_tests>"
	echo ""
