...
-  SPM/FF-A testing:
   ...
   - Increase test coverage for RXTX_MAP/RXTX_UNMAP.
   ...
   - Tests for Hypervisor retrieve request: contents checks, fragmented request,
     verify receivers.
   - Test RME enabled platform the FFA_MEM_LEND/FFA_MEM_DONATE.
   - Fix a few arguments used in the hypervisor retrieve request tests.
   - Fix notifications test to clean-up after itself, and destroy bitmap
