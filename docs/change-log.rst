...
-  More tests are made available in this release to help validate the
   ...
   -  Many tests to exercise Firmware Framework for A-class(FF-A) v1.0 ABIs.
   -  Scalable Vector Extensions(SVE) test scenarios.
...
-  Enable 8 cores support for Theodul(L3 subsystem for use with next generation
   A-class cores.
