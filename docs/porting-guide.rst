...
The value should be obtained from a reliable source of randomness. This is not
the case of the default implementation provided in the common platform layer.
