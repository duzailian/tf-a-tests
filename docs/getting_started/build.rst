...
For SPM-MM, build TF-A following the `TF-A documentation`_ and the following
...
For SPM based on SPCI and SPRT, build TF-A following the `TF-A documentation`_
