...
*******************************************************/
struct fuzzer_arg_def {
	int regnum;
	char smcname[FUZZ_MAX_NAME_SIZE];
	char smcargname[FUZZ_MAX_NAME_SIZE];
	int bitw;
	int bitst;
	char bnames[FUZZ_MAX_NAME_SIZE];
	uint64_t defval;
	uint64_t **contval;
	int *contvallen;
	int contlen;
...
struct fuzzer_arg_arange {
	int arg_span[2];
};

/*******************************************************
* Include the specific fields for SMC call
*******************************************************/
