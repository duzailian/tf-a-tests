...
{
	switch (n) {
		case 0:  return read_icc_ppi_priorityr0();
		case 1:  return read_icc_ppi_priorityr1();
		case 2:  return read_icc_ppi_priorityr2();
		case 3:  return read_icc_ppi_priorityr3();
		case 4:  return read_icc_ppi_priorityr4();
		case 5:  return read_icc_ppi_priorityr5();
		case 6:  return read_icc_ppi_priorityr6();
		case 7:  return read_icc_ppi_priorityr7();
		case 8:  return read_icc_ppi_priorityr8();
		case 9:  return read_icc_ppi_priorityr9();
		case 10: return read_icc_ppi_priorityr10();
		case 11: return read_icc_ppi_priorityr11();
		case 12: return read_icc_ppi_priorityr12();
		case 13: return read_icc_ppi_priorityr13();
		case 14: return read_icc_ppi_priorityr14();
		case 15: return read_icc_ppi_priorityr15();
		default: panic();
	}
}
...
{
	switch (n) {
		case 0:  return write_icc_ppi_priorityr0(val);
		case 1:  return write_icc_ppi_priorityr1(val);
		case 2:  return write_icc_ppi_priorityr2(val);
		case 3:  return write_icc_ppi_priorityr3(val);
		case 4:  return write_icc_ppi_priorityr4(val);
		case 5:  return write_icc_ppi_priorityr5(val);
		case 6:  return write_icc_ppi_priorityr6(val);
		case 7:  return write_icc_ppi_priorityr7(val);
		case 8:  return write_icc_ppi_priorityr8(val);
		case 9:  return write_icc_ppi_priorityr9(val);
		case 10: return write_icc_ppi_priorityr10(val);
		case 11: return write_icc_ppi_priorityr11(val);
		case 12: return write_icc_ppi_priorityr12(val);
		case 13: return write_icc_ppi_priorityr13(val);
		case 14: return write_icc_ppi_priorityr14(val);
		case 15: return write_icc_ppi_priorityr15(val);
		default: panic();
	}
}
