...
#define SMC_TRNG_RND_AARCH32			0x84000053
#define SMC_TRNG_RND_AARCH64			0xc4000053
...
smc_ret_values tftf_trng_rnd32(uint32_t nbits);
smc_ret_values tftf_trng_rnd64(uint32_t nbits);
#endif /* __ASSEMBLY__ */
 ...
 * TRNG version
 ******************************************************************************/
#define TRNG_MAJOR_VER		(1)
#define TRNG_MINOR_VER		(0)
#define TRNG_MAJOR_VER_SHIFT	(16)
#define TRNG_MAJOR_VER_MASK	(0xFFFF0000)
