...
/**
 * Get command from ffa_value.
 */
static inline uint64_t cactus_get_cmd(ffa_value ret)
{
 ...
 * messages interfaces.
 */
static inline ffa_value cactus_send_cmd(
 ...
 */
static inline ffa_value cactus_send_response(
 ...
 * specific test.
 */
static inline ffa_value cactus_success_resp(
 ...
 */
static inline ffa_value cactus_error_resp(
...
static inline uint32_t cactus_error_code(ffa_value ret)
{
...
static inline ffa_value cactus_echo_send_cmd(
...
static inline uint64_t cactus_echo_get_val(ffa_value ret)
{
...
static inline ffa_value cactus_req_echo_send_cmd(
...
static inline ffa_id_t cactus_req_echo_get_echo_dest(ffa_value ret)
{
...
static inline ffa_value cactus_deadlock_send_cmd(
...
static inline ffa_id_t cactus_deadlock_get_next_dest(ffa_value ret)
{
...
static inline ffa_value cactus_req_deadlock_send_cmd(
...
static inline ffa_id_t cactus_deadlock_get_next_dest2(ffa_value ret)
{
	return (ffa_id_t)ret.arg5;
}
...
static inline ffa_value cactus_mem_send_cmd(
...
static inline ffa_memory_handle_t cactus_mem_send_get_handle(ffa_value ret)
{
...
static inline uint16_t cactus_mem_send_words_to_write(ffa_value ret)
{
	return (uint16_t)ret.arg7;
}

static inline bool cactus_mem_send_get_non_secure(ffa_value ret)
{
...
static inline ffa_value cactus_req_mem_send_send_cmd(
	ffa_id_t source, ffa_id_t dest, uint32_t mem_func,
...
static inline uint32_t cactus_req_mem_send_get_mem_func(ffa_value ret)
{
	return (uint32_t)ret.arg4;
}

static inline ffa_id_t cactus_req_mem_send_get_receiver(ffa_value ret)
{
	return (ffa_id_t)ret.arg5;
}

static inline bool cactus_req_mem_send_get_non_secure(ffa_value ret)
{
...
static inline ffa_value cactus_req_simd_fill_send_cmd(
...
static inline ffa_value cactus_sleep_cmd(
...
static inline ffa_value cactus_fwd_sleep_cmd(
...
static inline uint32_t cactus_get_sleep_time(ffa_value ret)
{
	return (uint32_t)ret.arg4;
}

static inline ffa_id_t cactus_get_fwd_sleep_dest(ffa_value ret)
{
	return (ffa_id_t)ret.arg5;
}
...
static inline ffa_value cactus_sleep_trigger_wdog_cmd(
	ffa_id_t source, ffa_id_t dest, uint32_t sleep_time,
	uint64_t wdog_time)
{
...
static inline uint32_t cactus_get_wdog_trigger_duration(ffa_value ret)
{
...
static inline ffa_value cactus_interrupt_cmd(
...
static inline uint32_t cactus_get_interrupt_id(ffa_value ret)
{
	return (uint32_t)ret.arg4;
}

static inline bool cactus_get_interrupt_enable(ffa_value ret)
{
	return (bool)ret.arg5;
}

static inline enum interrupt_pin cactus_get_interrupt_pin(ffa_value ret)
{
...
static inline ffa_value cactus_send_dma_cmd(
	ffa_id_t source, ffa_id_t dest)
{
...
static inline ffa_value cactus_notification_bind_send_cmd(
...
static inline ffa_value cactus_notification_unbind_send_cmd(
	ffa_id_t source, ffa_id_t dest, ffa_id_t receiver,
...
static inline ffa_id_t cactus_notification_get_receiver(ffa_value ret)
{
	return (ffa_id_t)ret.arg4;
}

static inline ffa_id_t cactus_notification_get_sender(ffa_value ret)
{
	return (ffa_id_t)ret.arg5;
}
...
static inline ffa_value cactus_notification_get_send_cmd(
	ffa_id_t source, ffa_id_t dest, ffa_id_t receiver,
...
static inline uint32_t cactus_notification_get_vcpu(ffa_value ret)
{
	return (uint32_t)ret.arg5;
}

static inline uint32_t cactus_notification_get_flags(ffa_value ret)
{
	return (uint32_t)ret.arg7;
}

static inline ffa_value cactus_notifications_get_success_resp(
...
static inline uint64_t cactus_notifications_get_from_sp(ffa_value ret)
{
	return (uint64_t)ret.arg4;
}

static inline uint64_t cactus_notifications_get_from_vm(ffa_value ret)
{
	return (uint64_t)ret.arg5;
}

static inline bool cactus_notifications_check_npi_handled(ffa_value ret)
{
	return (bool)ret.arg6;
}
...
static inline ffa_value cactus_notifications_set_send_cmd(
	ffa_id_t source, ffa_id_t dest, ffa_id_t receiver,
...
static inline ffa_id_t cactus_notifications_set_get_receiver(ffa_value ret)
{
	return (ffa_id_t)(ret.arg4 & 0xFFFFU);
}

static inline ffa_id_t cactus_notifications_set_get_sender(ffa_value ret)
{
...
static inline ffa_value cactus_send_twdog_cmd(
...
static inline uint32_t cactus_get_wdog_duration(ffa_value ret)
{
	return (uint32_t)ret.arg4;
}
...
static inline ffa_value cactus_get_req_count_send_cmd(
	ffa_id_t source, ffa_id_t dest)
{
...
static inline uint32_t cactus_get_req_count(ffa_value ret)
{
	return (uint32_t)ret.arg4;
}
...
static inline ffa_value cactus_get_last_interrupt_cmd(
	ffa_id_t source, ffa_id_t dest)
{
