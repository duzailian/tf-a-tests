...
static inline ffa_memory_handle_t cactus_mem_send_get_handle(struct ffa_value ret)
{
...
static inline ffa_id_t cactus_notifications_set_get_receiver(struct ffa_value ret)
{
