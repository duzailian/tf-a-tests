...
#ifndef NS_SHARED_DATA_H
#define NS_SHARED_DATA_H
...
/*
 * This structure map the shared memory to be used between the Host and Realm
 * payload
 */
...
/*
 * Different command that the Host can requests the Realm to perform
 */
enum realm_cmd {
	REALM_SLEEP_CMD = 1,
