...
#define RMI_ABI_VERSION_VAL \
	((RMI_ABI_VERSION_MAJOR << 16U) | RMI_ABI_VERSION_MINOR)
...
struct rmi_rec_params {
	...
	SET_MEMBER(u_register_t gprs[REC_CREATE_NR_GPRS], 0x300,
		   0x800); /* 0x300 */
	SET_MEMBER(
		struct {
...
struct rmi_rec_entry {
	...
	/* General-purpose registers */
	SET_MEMBER(u_register_t gprs[REC_EXIT_NR_GPRS], 0x200,
		   0x300); /* 0x200 */
	SET_MEMBER(
		struct {
