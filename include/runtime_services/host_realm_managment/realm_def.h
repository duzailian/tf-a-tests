...
#define REALM_IMAGE_SIZE		0x100000U
#define REALM_STACK_SIZE		0x1000U
#define REALM_CORE_COUNT		1U
...
#define PAGE_ALIGNMENT			PAGE_SIZE_16KB
#define TCR_TG0				TCR_TG0_16K
#elif (PAGE_SIZE == PAGE_SIZE_64KB)
#define PAGE_ALIGNMENT			PAGE_SIZE_64KB
#define TCR_TG0				TCR_TG0_64K
#else
