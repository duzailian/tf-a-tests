...
typedef struct sc_value ffa_value;

static inline uint32_t ffa_func_id(ffa_value val)
{
	return (uint32_t) val.fid;
}

static inline int32_t ffa_error_code(ffa_value val)
{
	return (int32_t) val.arg2;
}

static inline ffa_id_t ffa_endpoint_id(ffa_value val) {
	return (ffa_id_t) val.arg2 & 0xffff;
}

static inline uint32_t ffa_partition_info_count(ffa_value val)
{
	return (uint32_t) val.arg2;
}

static inline uint32_t ffa_feature_intid(ffa_value val)
{
	return (uint32_t)val.arg2;
}
...
static inline ffa_memory_handle_t ffa_mem_success_handle(ffa_value r)
{
...
static inline ffa_id_t ffa_dir_msg_dest(ffa_value val) {
	return (ffa_id_t)val.arg1 & U(0xFFFF);
}

static inline ffa_id_t ffa_dir_msg_source(ffa_value val) {
	return (ffa_id_t)(val.arg1 >> 16U);
}

ffa_value ffa_msg_send_direct_req64(ffa_id_t source_id,
				    ffa_id_t dest_id, uint64_t arg0,
				    uint64_t arg1, uint64_t arg2,
				    uint64_t arg3, uint64_t arg4);

ffa_value ffa_msg_send_direct_req32(ffa_id_t source_id,
				    ffa_id_t dest_id, uint32_t arg0,
				    uint32_t arg1, uint32_t arg2,
				    uint32_t arg3, uint32_t arg4);

ffa_value ffa_msg_send_direct_resp64(ffa_id_t source_id,
				     ffa_id_t dest_id, uint64_t arg0,
				     uint64_t arg1, uint64_t arg2,
				     uint64_t arg3, uint64_t arg4);

ffa_value ffa_msg_send_direct_resp32(ffa_id_t source_id,
				     ffa_id_t dest_id, uint32_t arg0,
				     uint32_t arg1, uint32_t arg2,
				     uint32_t arg3, uint32_t arg4);

ffa_value ffa_run(uint32_t dest_id, uint32_t vcpu_id);
ffa_value ffa_version(uint32_t input_version);
ffa_value ffa_id_get(void);
ffa_value ffa_spm_id_get(void);
ffa_value ffa_msg_wait(void);
ffa_value ffa_error(int32_t error_code);
ffa_value ffa_features(uint32_t feature);
ffa_value ffa_partition_info_get(const struct ffa_uuid uuid);
ffa_value ffa_rx_release(void);
ffa_value ffa_rxtx_map(uintptr_t send, uintptr_t recv, uint32_t pages);
ffa_value ffa_rxtx_unmap(void);
ffa_value ffa_mem_donate(uint32_t descriptor_length,
			 uint32_t fragment_length);
ffa_value ffa_mem_lend(uint32_t descriptor_length,
		       uint32_t fragment_length);
ffa_value ffa_mem_share(uint32_t descriptor_length,
			uint32_t fragment_length);
ffa_value ffa_mem_retrieve_req(uint32_t descriptor_length,
			       uint32_t fragment_length);
ffa_value ffa_mem_relinquish(void);
ffa_value ffa_mem_reclaim(uint64_t handle, uint32_t flags);
ffa_value ffa_notification_bitmap_create(ffa_id_t vm_id,
					 ffa_vcpu_count_t vcpu_count);
ffa_value ffa_notification_bitmap_destroy(ffa_id_t vm_id);
ffa_value ffa_notification_bind(ffa_id_t sender, ffa_id_t receiver,
				uint32_t flags,
				ffa_notification_bitmap_t notifications);
ffa_value ffa_notification_unbind(ffa_id_t sender, ffa_id_t receiver,
				  ffa_notification_bitmap_t notifications);
ffa_value ffa_notification_set(ffa_id_t sender, ffa_id_t receiver,
			       uint32_t flags,
			       ffa_notification_bitmap_t bitmap);
ffa_value ffa_notification_get(ffa_id_t receiver, uint32_t vcpu_id,
			       uint32_t flags);
ffa_value ffa_notification_info_get(void);
#endif /* __ASSEMBLY__ */
