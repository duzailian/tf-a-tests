...
#define FFA_NOTIFICATION_FLAGS_VCPU_ID(id) UINT32_C((id & 0xFFFF) << 16)

static inline ffa_notification_bitmap_t ffa_notification_get_from_sp(
       struct ffa_value val)
{
	return ffa_notification_bitmap(val.arg2, val.arg3);
}

static inline ffa_notification_bitmap_t ffa_notification_get_from_vm(
       struct ffa_value val)
{
	return ffa_notification_bitmap(val.arg4, val.arg5);
}
...
_Static_assert(sizeof(struct ffa_endpoint_rx_tx_descriptor) == 16,
