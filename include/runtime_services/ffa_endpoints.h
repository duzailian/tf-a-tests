...
/* vcpu_count of cactus SPs as defined in fvp_spmc_manifest.dts */
#define PRIMARY_EXEC_CTX	(8)
#define SECONDARY_EXEC_CTX	(8)
#define TERTIARY_EXEC_CTX	(1)
#define IVY_EXEC_CTX		(1)
