...
#define RMI_FNUM_GRANULE_CREATE     U(0x158)
#define RMI_FNUM_GRANULE_DESTROY    U(0x159)
...
#define SMC_RMM_GRANULE_CREATE      RMI_FID(SMC_64, \
						RMI_FNUM_GRANULE_CREATE)
#define SMC_RMM_GRANULE_DESTROY     RMI_FID(SMC_64, \
						RMI_FNUM_GRANULE_DESTROY)
...
u_register_t realm_granule_create(uintptr_t, uintptr_t);
u_register_t realm_granule_destroy(uintptr_t);