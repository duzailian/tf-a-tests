...
/*
 * Stage 2 translation Lower attributes when FEAT_S2FWB is enabled.
 * We set HCR_EL2.FWB So we set bit[4] to 1 and bits[3:2] to 0b10 and force
 * everything to be Normal Write-Back
 */
