...
#define HFGITR_EL2_FEAT_BRBE_MASK		U(0x180000000000000)
#define HFGITR_EL2_FEAT_SPECRES_MASK		U(0x7000000000000)
#define HFGITR_EL2_FEAT_TLBIRANGE_MASK		U(0x3fc00000000)
#define HFGITR_EL2_FEAT_TLBIRANGE_TLBIOS_MASK	U(0xf000000)
#define HFGITR_EL2_FEAT_TLBIOS_MASK		U(0xfc0000)
#define HFGITR_EL2_FEAT_PAN2_MASK		U(0x30000)
#define HFGITR_EL2_FEAT_DPB2_MASK		U(0x200)
#define HFGITR_EL2_NON_FEAT_DEPENDENT_MASK	U(0x78fc03f000fdff)

#define HFGRTR_EL2_INIT_VAL     		U(0xc4000000000000)
#define HFGRTR_EL2_FEAT_SME_MASK		U(0xc0000000000000)
#define HFGRTR_EL2_FEAT_LS64_ACCDATA_MASK	U(0x4000000000000)
#define HFGRTR_EL2_FEAT_RAS_MASK		U(0x27f0000000000)
#define HFGRTR_EL2_FEAT_RASV1P1_MASK		U(0x1800000000000)
#define HFGRTR_EL2_FEAT_GICV3_MASK		U(0x800000000)
#define HFGRTR_EL2_FEAT_CSV2_2_CSV2_1P2_MASK	U(0xc0000000)
#define HFGRTR_EL2_FEAT_LOR_MASK		U(0xf80000)
#define HFGRTR_EL2_FEAT_PAUTH_MASK		U(0x1f0)
#define HFGRTR_EL2_NON_FEAT_DEPENDENT_MASK	U(0x7f3f07fe0f)

#define HFGWTR_EL2_INIT_VAL     		U(0xc4000000000000)
#define HFGWTR_EL2_FEAT_SME_MASK		U(0xc0000000000000)
#define HFGWTR_EL2_FEAT_LS64_ACCDATA_MASK	U(0x4000000000000)
#define HFGWTR_EL2_FEAT_RAS_MASK		U(0x23a0000000000)
#define HFGWTR_EL2_FEAT_RASV1P1_MASK		U(0x1800000000000)
#define HFGWTR_EL2_FEAT_GICV3_MASK		U(0x8000000000)
#define HFGWTR_EL2_FEAT_CSV2_2_CSV2_1P2_MASK	U(0xc0000000)
#define HFGWTR_EL2_FEAT_LOR_MASK		U(0xf80000)
#define HFGWTR_EL2_FEAT_PAUTH_MASK		U(0x1f0)
#define HFGWTR_EL2_NON_FEAT_DEPENDENT_MASK	U(0x7f2903380b)
