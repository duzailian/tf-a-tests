...
{
	u_register_t id_aa64mfr1_pan =
		EXTRACT(ID_AA64MMFR1_EL1_PAN, read_id_aa64mmfr1_el1());
	return (id_aa64mfr1_pan >= ID_AA64MMFR1_EL1_PAN_SUPPORTED) &&
		(id_aa64mfr1_pan <= ID_AA64MMFR1_EL1_PAN3_SUPPORTED);
}
...
static inline bool is_armv8_2_pan2_present(void)
{
	u_register_t id_aa64mfr1_pan =
		EXTRACT(ID_AA64MMFR1_EL1_PAN, read_id_aa64mmfr1_el1());
	return (id_aa64mfr1_pan >= ID_AA64MMFR1_EL1_PAN2_SUPPORTED) &&
		(id_aa64mfr1_pan <= ID_AA64MMFR1_EL1_PAN3_SUPPORTED);
}
