...
static inline void paciasp(void)
{
	__asm__ (".inst 0xD503233F");
}
static inline void autiasp(void)
{
	__asm__ (".inst 0xD50323BF");
}
static inline void xpaclri(void)
{
	__asm__ (".inst 0xD50320FF");
}
