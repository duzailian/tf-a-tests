...
/* Armv9.3 MPAM PE side Bandwidth control Registers */
DEFINE_RENAME_SYSREG_RW_FUNCS(mpambw2_el2, MPAMBW2_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(mpambw1_el1, MPAMBW1_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(mpambwidr_el1, MPAMBWIDR_EL1)
...
/* Armv8.8 Physical Fault Address Register Extension */
DEFINE_RENAME_SYSREG_RW_FUNCS(pfar_el2, PFAR_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(pfar_el1, PFAR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(pfar_el12, PFAR_EL12)

/* Armv8.8 Memory Attribute Index Enhancement */
DEFINE_RENAME_SYSREG_RW_FUNCS(mair2_el1, MAIR2_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(mair2_el2, MAIR2_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(mair2_el12, MAIR2_EL12)
DEFINE_RENAME_SYSREG_RW_FUNCS(amair2_el1, AMAIR2_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(amair2_el2, AMAIR2_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(amair2_el12, AMAIR2_EL12)
