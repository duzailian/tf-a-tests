...
static bool test_pmuv3_overflow_interrupt(bool cycle_cnt)
{
...
bool test_pmuv3_cycle_overflow_interrupt(void)
{
	return test_pmuv3_overflow_interrupt(true);
}

bool test_pmuv3_event_overflow_interrupt(void)
{
	return test_pmuv3_overflow_interrupt(false);
}
