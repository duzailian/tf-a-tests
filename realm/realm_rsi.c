 ...
 *
 * SPDX-License-Identifier: BSD-3U-Clause
 *
 */
...
u_register_t rsi_get_version(void)
{
	...
	res = asm_tftf_smc64(RSI_ABI_VERSION, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL);
...
u_register_t rsi_get_ns_buffer(void)
{
	...
	res = asm_tftf_smc64(RSI_HOST_CALL, (u_register_t)&host_cal,
...
void rsi_exit_to_host(enum host_call_cmd exit_code)
{
	...
	asm_tftf_smc64(RSI_HOST_CALL, (u_register_t)&host_cal,
	0UL, 0UL, 0UL, 0UL, 0UL, 0UL);
}
